...
void nfc_magic_scene_slix_menu_on_enter(void *context) {
  ...
  submenu_add_item(submenu, "More info (WIP)", SubmenuIndexMoreInfo,
                   nfc_magic_scene_slix_menu_submenu_callback, instance);

  submenu_set_selected_item(
      submenu, scene_manager_get_scene_state(instance->scene_manager,
                                             NfcMagicSceneSlixMenu));
